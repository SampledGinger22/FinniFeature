...
import { archivePatientRoute, restorePatientRoute, unarchivePatientRoute } from '@/http/patientRoutes';
import type { RouteResult } from '@/http/patientRoutes';

// Lifecycle actions for one patient: POST /api/patients/:id/{archive|unarchive|restore} (§12).
